...
### UI/UX Override - the card lifted onto the notice

#### Resolve Issues

- [ ] Landing Breakdown 1: the lifted card lands under the LANDED notice on a
  phone held upright
...
- [ ] The right-hand pad cluster is drawn off the edge of a 320 pixel screen
...
- [ ] The muted notice sits in the pad band on a screen held sideways
  ...
  - From: UI/UX Override - the card lifted onto the notice
- [ ] The pitch keys carry the nose the opposite way to what the controls say
